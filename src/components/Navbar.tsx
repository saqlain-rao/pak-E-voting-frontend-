...
export function Navbar() {
  ...
  return (
    <nav className="fixed top-4 left-4 right-4 md:left-8 md:right-8 lg:left-12 lg:right-12 glass-panel-dark flex items-center justify-between px-6 py-4 shadow-2xl z-50 transition-all duration-300">
