...
export default function Home() {
  return (
    <div className="w-full min-h-screen bg-[#f8fafc] flex flex-col items-center">
      ...
      {/* Main Actions Cards */}
      <div className="relative z-20 -mt-16 max-w-6xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-3 gap-8 pb-24">
        ...
        <motion.a 
          ...
          whileHover={{ y: -8 }}
          className="glass-panel p-8 flex flex-col items-center text-center transition-all group hover:border-[#d4af37]/50 hover:shadow-[0_20px_40px_-15px_rgba(0,77,40,0.3)] bg-white/80"
        >
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#004D28]/10 to-[#004D28]/5 text-[#004D28] flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all border border-[#004D28]/10 shadow-sm">
            <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
            </svg>
          </div>
          <h2 className="text-2xl font-extrabold text-[#004D28] mb-4">Citizen KYC</h2>
          ...
          <div className="mt-auto px-6 py-2.5 bg-[#004D28]/5 text-[#004D28] rounded-full font-bold group-hover:bg-[#004D28] group-hover:text-white transition-colors text-sm w-full">
            Verify Now →
          </div>
        </motion.a>
        ...
        <motion.a 
          ...
          whileHover={{ y: -8 }}
          className="glass-panel p-8 flex flex-col items-center text-center transition-all group hover:border-[#d4af37] hover:shadow-[0_20px_40px_-15px_rgba(212,175,55,0.3)] bg-white/80 relative overflow-hidden"
        >
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#d4af37] to-[#f5d76e]"></div>
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#d4af37]/10 to-[#d4af37]/5 text-[#d4af37] flex items-center justify-center mb-6 group-hover:scale-110 group-hover:-rotate-3 transition-all border border-[#d4af37]/20 shadow-sm">
            <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
            </svg>
          </div>
          <h2 className="text-2xl font-extrabold text-[#004D28] mb-4">Candidate Portal</h2>
          <p className="text-slate-600 mb-8 font-medium leading-relaxed text-sm">
            Register your candidacy for upcoming national elections. Submit documentation and track your application status.
          </p>
          <div className="mt-auto px-6 py-2.5 bg-[#d4af37]/10 text-[#a68621] rounded-full font-bold group-hover:bg-gradient-to-r group-hover:from-[#d4af37] group-hover:to-[#f5d76e] group-hover:text-[#002614] transition-all text-sm w-full">
            Register →
          </div>
        </motion.a>
        ...
        <motion.a 
          ...
          whileHover={{ y: -8 }}
          className="glass-panel p-8 flex flex-col items-center text-center transition-all group hover:border-[#004D28]/50 hover:shadow-[0_20px_40px_-15px_rgba(0,77,40,0.3)] bg-white/80"
        >
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-[#004D28]/10 to-[#004D28]/5 text-[#004D28] flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all border border-[#004D28]/10 shadow-sm">
            <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <h2 className="text-2xl font-extrabold text-[#004D28] mb-4">Live Elections</h2>
          <p className="text-slate-600 mb-8 font-medium leading-relaxed text-sm">
