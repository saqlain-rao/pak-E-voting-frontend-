...
export default function Home() {
  return (
    <div className="w-full min-h-screen bg-[#f8fafc] flex flex-col items-center">
      ...
      <div className="w-full bg-premium-blue text-white pt-32 pb-24 relative overflow-hidden border-b-[6px] border-[#d4af37] shadow-[0_20px_50px_rgba(0,38,20,0.5)]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1] drop-shadow-2xl !text-[#d4af37]">
              National Database & <br/> E-Voting Authority
            </h1>
            <p className="text-lg md:text-xl text-blue-50/80 mb-10 leading-relaxed font-light max-w-2xl mx-auto md:mx-0">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-4">
              <a href="/kyc" className="px-8 py-4 bg-[#d4af37] text-[#002d5c] font-extrabold rounded-full hover:bg-[#f5d76e] transition-all shadow-[0_0_20px_rgba(212,175,55,0.4)] hover:shadow-[0_0_30px_rgba(212,175,55,0.6)] hover:-translate-y-1">
                Verify Identity
              </a>
      ...
      <div className="relative z-20 mt-12 max-w-6xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-3 gap-8 pb-24">
        ...
        <motion.a 
          ...
          className="relative overflow-hidden p-8 flex flex-col items-center text-center group bg-white backdrop-blur-2xl border border-white/80 rounded-3xl shadow-[0_20px_50px_-15px_rgba(0,77,40,0.15)] hover:shadow-[0_40px_80px_-15px_rgba(0,77,40,0.3)] hover:border-[#1d70b8]/40 transition-all duration-500"
        >
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-[#1d70b8]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          
          <div className="relative w-24 h-24 mb-8 flex items-center justify-center">
            <div className="absolute inset-0 bg-gradient-to-br from-[#1d70b8]/20 to-[#1d70b8]/5 rounded-3xl transform rotate-6 group-hover:rotate-12 transition-transform duration-500"></div>
            <div className="absolute inset-0 bg-white/80 backdrop-blur-md rounded-3xl border border-white/60 shadow-lg flex items-center justify-center group-hover:-rotate-3 transition-transform duration-500">
              <svg className="w-10 h-10 text-[#1d70b8]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2" />
              </svg>
            </div>
          </div>
          
          <h2 className="text-2xl font-black text-[#1d70b8] mb-4 tracking-tight relative z-10">Citizen KYC</h2>
        ...
        >
          ...
          <h2 className="text-2xl font-black text-[#1d70b8] mb-4 tracking-tight relative z-10">Candidate Portal</h2>
          <p className="text-slate-600 mb-8 font-medium leading-relaxed text-sm relative z-10">
        ...
        >
          ...
          <h2 className="text-2xl font-black text-[#1d70b8] mb-4 tracking-tight relative z-10">Live Elections</h2>
          <p className="text-slate-600 mb-8 font-medium leading-relaxed text-sm relative z-10">
      ...
      <div className="w-full bg-white/50 backdrop-blur-lg border-t border-gray-200/50 py-12 mt-auto">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-center gap-12 text-sm font-bold text-slate-500 uppercase tracking-widest">
          <div className="flex items-center gap-3 hover:text-[#1d70b8] transition-colors cursor-default">
